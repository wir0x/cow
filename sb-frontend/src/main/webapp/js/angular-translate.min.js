...
angular.module("pascalprecht.translate", ["ng"]).run(["$translate", function (a) {
    ...
    var c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r = {}, s = [], t = a, u = [], v = !1, w = "translate-cloak", x = !1, y = ".", z = 0, A = "2.6.1", B = function () {
        ...
        if (angular.isArray(d.languages))for (a = 0; a < d.languages.length; a++)if (c = d.languages[a], c && c.length)return c;
    ...
    this.storageKey = K, this.useUrlLoader = function (a, b) {
        ...
        var s, y, B, C = b.get(l || "$translateDefaultInterpolation"), L = !1, M = {}, N = {}, O = function (a, b, d, f) {
            ...
            var f = angular.extend({}, n, {key: a, $http: angular.extend({}, {cache: e}, n.$http)});
        ...
        if (O.preferredLanguage = function (a) {
                ...
                var f = j.defer();
                if (d.$emit("$translateRefreshStart", {language: a}), a)r[a] ? R(a).then(function (c) {
