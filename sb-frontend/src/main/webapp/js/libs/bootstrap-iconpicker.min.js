    ...
    t.fn.iconpicker = function (o, s) {
        return this.each(function () {
            ...
            if (i || n.data("bs.iconpicker", i = new e(this, a)), "string" == typeof o) {
                ...
                n.empty().append("<i></i>").append('<input type="hidden" ' + r + "></input>").append('<span class="caret"></span>'), n.addClass("iconpicker"), i.setIconset(c.iconset), n.on("click", function (t) {
