!function ($) {
    ...
    Datepicker.prototype = {
        constructor: Datepicker, _process_options: function (opts) {
            ...
            var date = altdate || this.date, local_date = this._utc_to_local(date);
            this.element.trigger({
                type: event, date: local_date, format: $.proxy(function (altformat) {
            ...
            return new Date(utc.getTime() + utc.getTimezoneOffset() * 6e4)
        }, _local_to_utc: function (local) {
            return new Date(local.getTime() - local.getTimezoneOffset() * 6e4)
            ...
            var oldDate = new Date(this.date), date, fromArgs = false;
            ...
            if (fromArgs) {
                ...
                if (oldDate.getTime() !== this.date.getTime())this._trigger("changeDate")
            } else {
