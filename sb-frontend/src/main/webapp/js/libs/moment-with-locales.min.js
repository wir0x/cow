!function (a, b) {
    ...
    function m(b) {
        l(this, b), this._d = new Date(+b._d), Ed === !1 && (Ed = !0, a.updateOffset(this), Ed = !1)
    }
    ...
    function t(a) {
        var b = null;
        if (!Fd[a] && "undefined" != typeof module && module && module.exports)try {
            b = Cd._abbr, require("./locale/" + a), u(b)
        } catch (c) {
        }
        return Fd[a]
    }
    ...
    function u(a, b) {
        var c;
        return a && (c = "undefined" == typeof b ? w(a) : v(a, b), c && (Cd = c)), Cd._abbr
    }

    function v(a, b) {
        return null !== b ? (b.abbr = a, Fd[a] || (Fd[a] = new q), Fd[a].set(b), u(a), Fd[a]) : (delete Fd[a], null)
    }
    ...
    function y(a) {
        return "string" == typeof a ? Gd[a] || Gd[a.toLowerCase()] : void 0
    }
    ...
    function H(a) {
        ...
        for (b = 0, c = d.length; c > b; b++)d[b] = Kd[d[b]] ? Kd[d[b]] : G(d[b]);
        return function (e) {
            var f = "";
    ...
    function I(a, b) {
        return a.isValid() ? (b = J(b, a.localeData()), Jd[b] || (Jd[b] = H(b)), Jd[b](a)) : a.localeData().invalidDate()
    }
    ...
    function K(a, b, c) {
        Zd[a] = "function" == typeof b ? b : function (a) {
            return a && c ? c : b
        }
    }

    function L(a, b) {
        return g(Zd, a) ? Zd[a](b._strict, b._locale) : new RegExp(M(a))
    }
    ...
    function X(a) {
        var b, c = a._a;
        return c && -2 === a._pf.overflow && (b = c[ae] < 0 || c[ae] > 11 ? ae : c[be] < 1 || c[be] > Q(c[_d], c[ae]) ? be : c[ce] < 0 || c[ce] > 24 || 24 === c[ce] && (0 !== c[de] || 0 !== c[ee] || 0 !== c[fe]) ? ce : c[de] < 0 || c[de] > 59 ? de : c[ee] < 0 || c[ee] > 59 ? ee : c[fe] < 0 || c[fe] > 999 ? fe : -1, a._pf._overflowDayOfYear && (_d > b || b > be) && (b = be), a._pf.overflow = b), a
    }
    ...
    function _(a) {
        var b, c, d = a._i, e = je.exec(d);
        if (e) {
            for (a._pf.iso = !0, b = 0, c = ke.length; c > b; b++)if (ke[b][1].exec(d)) {
                a._f = ke[b][0] + (e[6] || " ");
                break
            }
            for (b = 0, c = le.length; c > b; b++)if (le[b][1].exec(d)) {
                a._f += le[b][0];
                break
            }
            d.match(Wd) && (a._f += "Z"), sa(a)
        } else a._isValid = !1
    }
    ...
    function qa(a) {
        var b, c, d, e, f = [];
        if (!a._d) {
            for (d = pa(a), a._w && null == a._a[be] && null == a._a[ae] && ra(a), a._dayOfYear && (e = oa(a._a[_d], d[_d]), a._dayOfYear > da(e) && (a._pf._overflowDayOfYear = !0), c = ca(e, 0, a._dayOfYear), a._a[ae] = c.getUTCMonth(), a._a[be] = c.getUTCDate()), b = 0; 3 > b && null == a._a[b]; ++b)a._a[b] = f[b] = d[b];
            for (; 7 > b; b++)a._a[b] = f[b] = null == a._a[b] ? 2 === b ? 1 : 0 : a._a[b];
            24 === a._a[ce] && 0 === a._a[de] && 0 === a._a[ee] && 0 === a._a[fe] && (a._nextDay = !0, a._a[ce] = 0), a._d = (a._useUTC ? ca : ba).apply(null, f), null != a._tzm && a._d.setUTCMinutes(a._d.getUTCMinutes() - a._tzm), a._nextDay && (a._a[ce] = 24)
        }
    }

    function ra(a) {
        var b, c, d, e, f, g, h;
        b = a._w, null != b.GG || null != b.W || null != b.E ? (f = 1, g = 4, c = oa(b.GG, a._a[_d], ga(za(), 1, 4).year), d = oa(b.W, 1), e = oa(b.E, 1)) : (f = a._locale._week.dow, g = a._locale._week.doy, c = oa(b.gg, a._a[_d], ga(za(), f, g).year), d = oa(b.w, 1), null != b.d ? (e = b.d, f > e && ++d) : e = null != b.e ? b.e + f : f), h = ma(c, d, e, g, f), a._a[_d] = h.year, a._dayOfYear = h.dayOfYear
    }
    ...
    function sa(b) {
        ...
        for (e = J(b._f, b._locale).match(Hd) || [], c = 0; c < e.length; c++)f = e[c], d = (h.match(L(f, b)) || [])[0], d && (g = h.substr(0, h.indexOf(d)), g.length > 0 && b._pf.unusedInput.push(g), h = h.slice(h.indexOf(d) + d.length), j += d.length), Kd[f] ? (d ? b._pf.empty = !1 : b._pf.unusedTokens.push(f), P(f, d, b)) : b._strict && !d && b._pf.unusedTokens.push(f);
        b._pf.charsLeftOver = i - j, h.length > 0 && b._pf.unusedInput.push(h), b._pf.bigHour === !0 && b._a[ce] <= 12 && (b._pf.bigHour = void 0), b._a[ce] = ta(b._locale, b._a[ce], b._meridiem), qa(b), X(b)
    }
    ...
    function Ga(a) {
        var b = (a || "").match(Wd) || [], c = b[b.length - 1] || [], d = (c + "").match(re) || ["-", 0, 0], e = +(60 * d[1]) + o(d[2]);
        return "+" === d[0] ? e : -e
    }
    ...
    function Ua(a, b) {
        ...
        return Ea(a) ? f = {
            ...
            d: a._days,
            M: a._months
        } : "number" == typeof a ? (f = {}, b ? f[b] = a : f.milliseconds = a) : (h = se.exec(a)) ? (c = "-" === h[1] ? -1 : 1, f = {
            y: 0,
            d: o(h[be]) * c,
            h: o(h[ce]) * c,
            m: o(h[de]) * c,
    ...
    function ic() {
        var a = this._data;
        return this._milliseconds = Pe(this._milliseconds), this._days = Pe(this._days), this._months = Pe(this._months), a.milliseconds = Pe(a.milliseconds), a.seconds = Pe(a.seconds), a.minutes = Pe(a.minutes), a.hours = Pe(a.hours), a.months = Pe(a.months), a.years = Pe(a.years), this
    }
    ...
    function wc(a, b, c) {
        var d = Ua(a).abs(), e = df(d.as("s")), f = df(d.as("m")), g = df(d.as("h")), h = df(d.as("d")), i = df(d.as("M")), j = df(d.as("y")), k = e < ef.s && ["s", e] || 1 === f && ["m"] || f < ef.m && ["mm", f] || 1 === g && ["h"] || g < ef.h && ["hh", g] || 1 === h && ["d"] || h < ef.d && ["dd", h] || 1 === i && ["M"] || i < ef.M && ["MM", i] || 1 === j && ["y"] || ["yy", j];
        return k[2] = b, k[3] = +a > 0, k[4] = c, vc.apply(null, k)
    }

    function xc(a, b) {
        return void 0 === ef[a] ? !1 : void 0 === b ? ef[a] : (ef[a] = b, !0)
    }
    ...
    function zc() {
        var a = ff(this.years()), b = ff(this.months()), c = ff(this.days()), d = ff(this.hours()), e = ff(this.minutes()), f = ff(this.seconds() + this.milliseconds() / 1e3), g = this.asSeconds();
...
//! Author : Menelion ElensÃºle : https://github.com/Oire
    ...
    function Bc(a, b, c) {
        ...
        return "m" === c ? b ? "Ñ…Ð²Ñ–Ð»Ñ–Ð½Ð°" : "Ñ…Ð²Ñ–Ð»Ñ–Ð½Ñƒ" : "h" === c ? b ? "Ð³Ð°Ð´Ð·Ñ–Ð½Ð°" : "Ð³Ð°Ð´Ð·Ñ–Ð½Ñƒ" : a + " " + Ac(d[c], +a)
    }
    ...
    function Dc(a, b) {
        ...
        }, d = /\[ ?[Ð’Ð²] ?(?:Ð¼Ñ–Ð½ÑƒÐ»ÑƒÑŽ|Ð½Ð°ÑÑ‚ÑƒÐ¿Ð½ÑƒÑŽ)? ?\] ?dddd/.test(b) ? "accusative" : "nominative";
        return c[d][a.day()]
    }
...
//! based on (hr) translation by Bojan MarkoviÄ‡
    ...
    function Lc(a, b, c, d) {
        ...
        switch (c) {
            ...
            case"mm":
                return b || d ? e + (Kc(a) ? "minuty" : "minut") : e + "minutami";
                break;
            case"h":
                return b ? "hodina" : d ? "hodinu" : "hodinou";
            case"hh":
                return b || d ? e + (Kc(a) ? "hodiny" : "hodin") : e + "hodinami";
                break;
            case"d":
                return b || d ? "den" : "dnem";
            case"dd":
                return b || d ? e + (Kc(a) ? "dny" : "dnÃ­") : e + "dny";
                break;
            case"M":
                return b || d ? "mÄ›sÃ­c" : "mÄ›sÃ­cem";
            case"MM":
                return b || d ? e + (Kc(a) ? "mÄ›sÃ­ce" : "mÄ›sÃ­cÅ¯") : e + "mÄ›sÃ­ci";
                break;
            case"y":
                return b || d ? "rok" : "rokem";
            case"yy":
                return b || d ? e + (Kc(a) ? "roky" : "let") : e + "lety"
        }
    }
...
//! author : Bojan MarkoviÄ‡ : https://github.com/bmarkovic
    ...
    function Tc(a) {
        return (a ? "" : "[mÃºlt] ") + "[" + If[this.day()] + "] LT[-kor]"
    }
...
//! author : Hinrik Ã–rn SigurÃ°sson : https://github.com/hinrik
    ...
    function Yc(a, b, c, d) {
        ...
        switch (c) {
            ...
            case"mm":
                return Xc(a) ? e + (b || d ? "mÃ­nÃºtur" : "mÃ­nÃºtum") : b ? e + "mÃ­nÃºta" : e + "mÃ­nÃºtu";
            case"hh":
                return Xc(a) ? e + (b || d ? "klukkustundir" : "klukkustundum") : e + "klukkustund";
            case"d":
                return b ? "dagur" : d ? "dag" : "degi";
            case"dd":
                return Xc(a) ? b ? e + "dagar" : e + (d ? "daga" : "dÃ¶gum") : b ? e + "dagur" : e + (d ? "dag" : "degi");
            case"M":
                return b ? "mÃ¡nuÃ°ur" : d ? "mÃ¡nuÃ°" : "mÃ¡nuÃ°i";
            case"MM":
                return Xc(a) ? b ? e + "mÃ¡nuÃ°ir" : e + (d ? "mÃ¡nuÃ°i" : "mÃ¡nuÃ°um") : b ? e + "mÃ¡nuÃ°ur" : e + (d ? "mÃ¡nuÃ°" : "mÃ¡nuÃ°i");
            case"y":
                return b || d ? "Ã¡r" : "Ã¡ri";
            case"yy":
                return Xc(a) ? e + (b || d ? "Ã¡r" : "Ã¡rum") : e + (b || d ? "Ã¡r" : "Ã¡ri")
        }
    }
...
//! author : Irakli Janiashvili : https://github.com/irakli-janiashvili
    ...
    function $c(a, b) {
        ...
        }, d = /(áƒ¬áƒ˜áƒœáƒ|áƒ¨áƒ”áƒ›áƒ“áƒ”áƒ’)/.test(b) ? "accusative" : "nominative";
        return c[d][a.day()]
    }
...
//! author : mweimerskirch : https://github.com/mweimerskirch, David Raison : https://github.com/kwisatz
    ...
    function id(a, b) {
        var c = -1 === b.indexOf("dddd HH:mm"), d = Kf[a.day()];
    ...
    function md(a, b, c) {
        ...
        switch (c) {
            ...
            case"mm":
                return d + (ld(a) ? "minuty" : "minut");
            case"h":
                return b ? "godzina" : "godzinÄ™";
            case"hh":
                return d + (ld(a) ? "godziny" : "godzin");
            case"MM":
                return d + (ld(a) ? "miesiÄ…ce" : "miesiÄ™cy");
            case"yy":
                return d + (ld(a) ? "lata" : "lat")
        }
    }
...
//! Author : Menelion ElensÃºle : https://github.com/Oire
    ...
    function pd(a, b, c) {
        ...
        return "m" === c ? b ? "Ð¼Ð¸Ð½ÑƒÑ‚Ð°" : "Ð¼Ð¸Ð½ÑƒÑ‚Ñƒ" : a + " " + od(d[c], +a)
    }
    ...
    function ud(a, b, c, d) {
        ...
        switch (c) {
            ...
            case"mm":
                return b || d ? e + (td(a) ? "minÃºty" : "minÃºt") : e + "minÃºtami";
                break;
            case"h":
                return b ? "hodina" : d ? "hodinu" : "hodinou";
            case"hh":
                return b || d ? e + (td(a) ? "hodiny" : "hodÃ­n") : e + "hodinami";
                break;
            case"d":
                return b || d ? "deÅˆ" : "dÅˆom";
            case"dd":
                return b || d ? e + (td(a) ? "dni" : "dnÃ­") : e + "dÅˆami";
                break;
            case"M":
                return b || d ? "mesiac" : "mesiacom";
            case"MM":
                return b || d ? e + (td(a) ? "mesiace" : "mesiacov") : e + "mesiacmi";
                break;
            case"y":
                return b || d ? "rok" : "rokom";
            case"yy":
                return b || d ? e + (td(a) ? "roky" : "rokov") : e + "rokmi"
        }
    }
...
//! Author : Menelion ElensÃºle : https://github.com/Oire
    ...
    function xd(a, b, c) {
        ...
        return "m" === c ? b ? "Ñ…Ð²Ð¸Ð»Ð¸Ð½Ð°" : "Ñ…Ð²Ð¸Ð»Ð¸Ð½Ñƒ" : "h" === c ? b ? "Ð³Ð¾Ð´Ð¸Ð½Ð°" : "Ð³Ð¾Ð´Ð¸Ð½Ñƒ" : a + " " + wd(d[c], +a)
    }
    ...
    }), x("month", "M"), K("M", Qd), K("MM", Qd, Md), K("MMM", Yd), K("MMMM", Yd), N(["M", "MM"], function (a, b) {
        b[ae] = o(a) - 1
    }), N(["MMM", "MMMM"], function (a, b, c, d) {
        var e = c._locale.monthsParse(a, d, c._strict);
        null != e ? b[ae] = e : c._pf.invalidMonth = a
    });
    var ge = "January_February_March_April_May_June_July_August_September_October_November_December".split("_"), he = "Jan_Feb_Mar_Apr_May_Jun_Jul_Aug_Sep_Oct_Nov_Dec".split("_"), ie = {};
    a.suppressDeprecationWarnings = !1;
    var je = /^\s*(?:[+-]\d{6}|\d{4})-(?:(\d\d-\d\d)|(W\d\d$)|(W\d\d-\d)|(\d\d\d))((T| )(\d\d(:\d\d(:\d\d(\.\d+)?)?)?)?([\+\-]\d\d(?::?\d\d)?|\s*Z)?)?$/, ke = [["YYYYYY-MM-DD", /[+-]\d{6}-\d{2}-\d{2}/], ["YYYY-MM-DD", /\d{4}-\d{2}-\d{2}/], ["GGGG-[W]WW-E", /\d{4}-W\d{2}-\d/], ["GGGG-[W]WW", /\d{4}-W\d{2}/], ["YYYY-DDD", /\d{4}-\d{3}/]], le = [["HH:mm:ss.SSSS", /(T| )\d\d:\d\d:\d\d\.\d+/], ["HH:mm:ss", /(T| )\d\d:\d\d:\d\d/], ["HH:mm", /(T| )\d\d:\d\d/], ["HH", /(T| )\d\d/]], me = /^\/?Date\((\-?\d+)/i;
    ...
    }), F(0, ["YYYY", 4], 0, "year"), F(0, ["YYYYY", 5], 0, "year"), F(0, ["YYYYYY", 6, !0], 0, "year"), x("year", "y"), K("Y", Vd), K("YY", Qd, Md), K("YYYY", Sd, Od), K("YYYYY", Td, Pd), K("YYYYYY", Td, Pd), N(["YYYY", "YYYYY", "YYYYYY"], _d), N("YY", function (b, c) {
        c[_d] = a.parseTwoDigitYear(b)
    }), a.parseTwoDigitYear = function (a) {
        return o(a) + (o(a) > 68 ? 1900 : 2e3)
    };
    var ne = A("FullYear", !1);
    F("w", ["ww", 2], "wo", "week"), F("W", ["WW", 2], "Wo", "isoWeek"), x("week", "w"), x("isoWeek", "W"), K("w", Qd), K("ww", Qd, Md), K("W", Qd), K("WW", Qd, Md), O(["w", "ww", "W", "WW"], function (a, b, c, d) {
        b[d.substr(0, 1)] = o(a)
    });
    var oe = {dow: 0, doy: 6};
    F("DDD", ["DDDD", 3], "DDDo", "dayOfYear"), x("dayOfYear", "DDD"), K("DDD", Rd), K("DDDD", Nd), N(["DDD", "DDDD"], function (a, b, c) {
        c._dayOfYear = o(a)
    }), a.ISO_8601 = function () {
    };
    var pe = Z("moment().min is deprecated, use moment.min instead. https://github.com/moment/moment/issues/1548", function () {
        var a = za.apply(null, arguments);
        return this > a ? this : a
    }), qe = Z("moment().max is deprecated, use moment.max instead. https://github.com/moment/moment/issues/1548", function () {
        var a = za.apply(null, arguments);
        return a > this ? this : a
    });
    Fa("Z", ":"), Fa("ZZ", ""), K("Z", Wd), K("ZZ", Wd), N(["Z", "ZZ"], function (a, b, c) {
        c._useUTC = !0, c._tzm = Ga(a)
    });
    var re = /([\+\-]|\d\d)/gi;
    a.updateOffset = function () {
    };
    var se = /(\-)?(?:(\d*)\.)?(\d+)\:(\d+)(?:\:(\d+)\.?(\d{3})?)?/, te = /^(-)?P(?:(?:([0-9,.]*)Y)?(?:([0-9,.]*)M)?(?:([0-9,.]*)D)?(?:T(?:([0-9,.]*)H)?(?:([0-9,.]*)M)?(?:([0-9,.]*)S)?)?|([0-9,.]*)W)$/;
    Ua.fn = Da.prototype;
    var ue = Ya(1, "add"), ve = Ya(-1, "subtract");
    a.defaultFormat = "YYYY-MM-DDTHH:mm:ssZ";
    var we = Z("moment().lang() is deprecated. Instead, use moment().localeData() to get the language configuration. Use moment().locale() to change languages.", function (a) {
    ...
    }), xb("gggg", "weekYear"), xb("ggggg", "weekYear"), xb("GGGG", "isoWeekYear"), xb("GGGGG", "isoWeekYear"), x("weekYear", "gg"), x("isoWeekYear", "GG"), K("G", Vd), K("g", Vd), K("GG", Qd, Md), K("gg", Qd, Md), K("GGGG", Sd, Od), K("gggg", Sd, Od), K("GGGGG", Td, Pd), K("ggggg", Td, Pd), O(["gggg", "ggggg", "GGGG", "GGGGG"], function (a, b, c, d) {
        b[d.substr(0, 2)] = o(a)
    }), O(["gg", "GG"], function (b, c, d, e) {
        c[e] = a.parseTwoDigitYear(b)
    }), F("Q", 0, 0, "quarter"), x("quarter", "Q"), K("Q", Ld), N("Q", function (a, b) {
        b[ae] = 3 * (o(a) - 1)
    }), F("D", ["DD", 2], "Do", "date"), x("date", "D"), K("D", Qd), K("DD", Qd, Md), K("Do", function (a, b) {
        return a ? b._ordinalParse : b._ordinalParseLenient
    }), N(["D", "DD"], be), N("Do", function (a, b) {
        b[be] = o(a.match(Qd)[0], 10)
    });
    var xe = A("Date", !0);
    ...
    }, Ke = "Invalid date", Le = "%d", Me = /\d{1,2}/, Ne = {
        future: "in %s",
        past: "%s ago",
        s: "a few seconds",
        m: "a minute",
    ...
    Oe._calendar = Ie, Oe.calendar = Vb, Oe._longDateFormat = Je, Oe.longDateFormat = Wb, Oe._invalidDate = Ke, Oe.invalidDate = Xb, Oe._ordinal = Le, Oe.ordinal = Yb, Oe._ordinalParse = Me, Oe.preparse = Zb, Oe.postformat = Zb, Oe._relativeTime = Ne, Oe.relativeTime = $b, Oe.pastFuture = _b, Oe.set = ac, Oe.months = R, Oe._months = ge, Oe.monthsShort = S, Oe._monthsShort = he, Oe.monthsParse = T, Oe.week = ha, Oe._week = oe, Oe.firstDayOfYear = ja, Oe.firstDayOfWeek = ia, Oe.weekdays = Fb, Oe._weekdays = ye, Oe.weekdaysMin = Hb, Oe._weekdaysMin = Ae, Oe.weekdaysShort = Gb, Oe._weekdaysShort = ze, Oe.weekdaysParse = Ib, Oe.isPM = Ob, Oe._meridiemParse = Be, Oe.meridiem = Pb, u("en", {
...
//! momentjs.com
    ...
    var hf = a, jf = (hf.defineLocale("af", {
        ...
        week: {dow: 6, doy: 12}
    }), {1: "Ù¡", 2: "Ù¢", 3: "Ù£", 4: "Ù¤", 5: "Ù¥", 6: "Ù¦", 7: "Ù§", 8: "Ù¨", 9: "Ù©", 0: "Ù "}), kf = {
        "Ù¡": "1",
        "Ù¢": "2",
        "Ù£": "3",
        "Ù¤": "4",
        ...
        week: {dow: 1, doy: 4}
    }), {1: "Ù¡", 2: "Ù¢", 3: "Ù£", 4: "Ù¤", 5: "Ù¥", 6: "Ù¦", 7: "Ù§", 8: "Ù¨", 9: "Ù©", 0: "Ù "}), mf = {
        "Ù¡": "1",
        "Ù¢": "2",
        "Ù£": "3",
        "Ù¤": "4",
        ...
        return function (b, c) {
            var d = nf(b), e = of[a][nf(b)];
            return 2 === d && (e = e[c ? 0 : 1]), e.replace(/%d/i, b)
        }
    }, qf = ["ÙƒØ§Ù†ÙˆÙ† Ø§Ù„Ø«Ø§Ù†ÙŠ ÙŠÙ†Ø§ÙŠØ±", "Ø´Ø¨Ø§Ø· ÙØ¨Ø±Ø§ÙŠØ±", "Ø¢Ø°Ø§Ø± Ù…Ø§Ø±Ø³", "Ù†ÙŠØ³Ø§Ù† Ø£Ø¨Ø±ÙŠÙ„", "Ø£ÙŠØ§Ø± Ù…Ø§ÙŠÙˆ", "Ø­Ø²ÙŠØ±Ø§Ù† ÙŠÙˆÙ†ÙŠÙˆ", "ØªÙ…ÙˆØ² ÙŠÙˆÙ„ÙŠÙˆ", "Ø¢Ø¨ Ø£ØºØ³Ø·Ø³", "Ø£ÙŠÙ„ÙˆÙ„ Ø³Ø¨ØªÙ…Ø¨Ø±", "ØªØ´Ø±ÙŠÙ† Ø§Ù„Ø£ÙˆÙ„ Ø£ÙƒØªÙˆØ¨Ø±", "ØªØ´Ø±ÙŠÙ† Ø§Ù„Ø«Ø§Ù†ÙŠ Ù†ÙˆÙÙ…Ø¨Ø±", "ÙƒØ§Ù†ÙˆÙ† Ø§Ù„Ø£ÙˆÙ„ Ø¯ÙŠØ³Ù…Ø¨Ø±"], rf = (hf.defineLocale("ar", {
        months: qf,
        monthsShort: qf,
        weekdays: "Ø§Ù„Ø£Ø­Ø¯_Ø§Ù„Ø¥Ø«Ù†ÙŠÙ†_Ø§Ù„Ø«Ù„Ø§Ø«Ø§Ø¡_Ø§Ù„Ø£Ø±Ø¨Ø¹Ø§Ø¡_Ø§Ù„Ø®Ù…ÙŠØ³_Ø§Ù„Ø¬Ù…Ø¹Ø©_Ø§Ù„Ø³Ø¨Øª".split("_"),
        weekdaysShort: "Ø£Ø­Ø¯_Ø¥Ø«Ù†ÙŠÙ†_Ø«Ù„Ø§Ø«Ø§Ø¡_Ø£Ø±Ø¨Ø¹Ø§Ø¡_Ø®Ù…ÙŠØ³_Ø¬Ù…Ø¹Ø©_Ø³Ø¨Øª".split("_"),
        ...
        week: {dow: 1, doy: 4}
    }), "leden_Ãºnor_bÅ™ezen_duben_kvÄ›ten_Äerven_Äervenec_srpen_zÃ¡Å™Ã­_Å™Ã­jen_listopad_prosinec".split("_")), xf = "led_Ãºno_bÅ™e_dub_kvÄ›_Ävn_Ävc_srp_zÃ¡Å™_Å™Ã­j_lis_pro".split("_"), yf = (hf.defineLocale("cs", {
        months: wf,
        monthsShort: xf,
        ...
        calendar: function (a, b) {
            ...
            return "function" == typeof c && (c = c.apply(b)), c.replace("{}", d % 12 === 1 ? "ÏƒÏ„Î·" : "ÏƒÏ„Î¹Ï‚")
        },
        relativeTime: {
            future: "ÏƒÎµ %s",
            past: "%s Ï€ÏÎ¹Î½",
        ...
        ordinal: "%da",
        week: {dow: 1, doy: 7}
    }), "ene._feb._mar._abr._may._jun._jul._ago._sep._oct._nov._dic.".split("_")), zf = "ene_feb_mar_abr_may_jun_jul_ago_sep_oct_nov_dic".split("_"), Af = (hf.defineLocale("es", {
        ...
        ordinal: "%d.",
        week: {dow: 1, doy: 7}
    }), {1: "Û±", 2: "Û²", 3: "Û³", 4: "Û´", 5: "Ûµ", 6: "Û¶", 7: "Û·", 8: "Û¸", 9: "Û¹", 0: "Û°"}), Bf = {
        "Û±": "1",
        "Û²": "2",
        "Û³": "3",
        "Û´": "4",
        ...
        ordinal: "%dÙ…",
        week: {dow: 6, doy: 12}
    }), "nolla yksi kaksi kolme neljÃ¤ viisi kuusi seitsemÃ¤n kahdeksan yhdeksÃ¤n".split(" ")), Df = ["nolla", "yhden", "kahden", "kolmen", "neljÃ¤n", "viiden", "kuuden", Cf[7], Cf[8], Cf[9]], Ef = (hf.defineLocale("fi", {
        ...
        week: {dow: 1, doy: 4}
    }), "jan._feb._mrt._apr._mai_jun._jul._aug._sep._okt._nov._des.".split("_")), Ff = "jan_feb_mrt_apr_mai_jun_jul_aug_sep_okt_nov_des".split("_"), Gf = (hf.defineLocale("fy", {
        months: "jannewaris_febrewaris_maart_april_maaie_juny_july_augustus_septimber_oktober_novimber_desimber".split("_"),
        monthsShort: function (a, b) {
            return /-MMM-/.test(b) ? Ff[a.month()] : Ef[a.month()]
        },
        ...
        ordinal: "%d.",
        week: {dow: 1, doy: 7}
    }), "vasÃ¡rnap hÃ©tfÅ‘n kedden szerdÃ¡n csÃ¼tÃ¶rtÃ¶kÃ¶n pÃ©nteken szombaton".split(" ")), Jf = (hf.defineLocale("hu", {
    ...
    }), Kf = "sekmadienis_pirmadienis_antradienis_treÄiadienis_ketvirtadienis_penktadienis_Å¡eÅ¡tadienis".split("_"), Lf = (hf.defineLocale("lt", {
        ...
        meridiemHour: function (a, b) {
            return 12 === a && (a = 0), "à¤°à¤¾à¤¤à¥€" === b ? 3 > a ? a : a + 12 : "à¤¬à¤¿à¤¹à¤¾à¤¨" === b ? a : "à¤¦à¤¿à¤‰à¤à¤¸à¥‹" === b ? a >= 10 ? a : a + 12 : "à¤¬à¥‡à¤²à¥à¤•à¤¾" === b || "à¤¸à¤¾à¤à¤" === b ? a + 12 : void 0
        },
        meridiem: function (a) {
        ...
        week: {dow: 1, doy: 7}
    }), "jan._feb._mrt._apr._mei_jun._jul._aug._sep._okt._nov._dec.".split("_")), Tf = "jan_feb_mrt_apr_mei_jun_jul_aug_sep_okt_nov_dec".split("_"), Uf = (hf.defineLocale("nl", {
        months: "januari_februari_maart_april_mei_juni_juli_augustus_september_oktober_november_december".split("_"),
        monthsShort: function (a, b) {
            return /-MMM-/.test(b) ? Tf[a.month()] : Sf[a.month()]
        },
        ...
        ordinal: "%d.",
        week: {dow: 1, doy: 4}
    }), "styczeÅ„_luty_marzec_kwiecieÅ„_maj_czerwiec_lipiec_sierpieÅ„_wrzesieÅ„_paÅºdziernik_listopad_grudzieÅ„".split("_")), Vf = "stycznia_lutego_marca_kwietnia_maja_czerwca_lipca_sierpnia_wrzeÅ›nia_paÅºdziernika_listopada_grudnia".split("_"), Wf = (hf.defineLocale("pl", {
        months: function (a, b) {
            return /D MMMM/.test(b) ? Vf[a.month()] : Uf[a.month()]
        },
        ...
        week: {dow: 1, doy: 7}
    }), "januÃ¡r_februÃ¡r_marec_aprÃ­l_mÃ¡j_jÃºn_jÃºl_august_september_oktÃ³ber_november_december".split("_")), Xf = "jan_feb_mar_apr_mÃ¡j_jÃºn_jÃºl_aug_sep_okt_nov_dec".split("_"), Yf = (hf.defineLocale("sk", {
        months: Wf,
        monthsShort: Xf,
        monthsParse: function (a, b) {
            var c, d = [];
        ...
        words: {
            ...
            var d = Zf.words[c];
            return 1 === c.length ? b ? d[0] : d[1] : a + " " + Zf.correctGrammaticalCase(a, d)
        }
    }), $f = (hf.defineLocale("sr", {
        ...
        calendar: {
            sameDay: Ad("[Ð¡ÑŒÐ¾Ð³Ð¾Ð´Ð½Ñ– "),
            nextDay: Ad("[Ð—Ð°Ð²Ñ‚Ñ€Ð° "),
            lastDay: Ad("[Ð’Ñ‡Ð¾Ñ€Ð° "),
            nextWeek: Ad("[Ð£] dddd ["),
            lastWeek: function () {
                switch (this.day()) {
                    case 0:
                    ...
                    case 5:
                    case 6:
                        return Ad("[ÐœÐ¸Ð½ÑƒÐ»Ð¾Ñ—] dddd [").call(this);
                    case 1:
                    case 2:
                    case 4:
                        return Ad("[ÐœÐ¸Ð½ÑƒÐ»Ð¾Ð³Ð¾] dddd [").call(this)
                }
            },
            sameElse: "L"
        },
        ...
        calendar: {
            sameDay: function () {
                ...
                var a, b;
                return a = hf().startOf("week"), b = this.unix() - a.unix() >= 604800 ? "[ä¸‹]" : "[æœ¬]", 0 === this.minutes() ? b + "dddAhç‚¹æ•´" : b + "dddAhç‚¹mm"
            }, lastWeek: function () {
                var a, b;
                return a = hf().startOf("week"), b = this.unix() < a.unix() ? "[ä¸Š]" : "[æœ¬]", 0 === this.minutes() ? b + "dddAhç‚¹æ•´" : b + "dddAhç‚¹mm"
            }, sameElse: "LL"
        },
