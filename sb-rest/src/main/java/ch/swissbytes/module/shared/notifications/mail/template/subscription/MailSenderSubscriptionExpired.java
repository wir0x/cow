...
@Stateless
public class MailSenderSubscriptionExpired implements Serializable {
    ...
    public String getResource() {
        String result = "";
        try {
            InputStream in = EmailSenderSubscriptionInvitation.class.getResourceAsStream("/email-template/SubscriptionExpiredNotification.html");
    ...
    public void createEmailNotification(Device device) throws InvalidInputException {
        if (!mailUtil.validate(device.getAccount().getEmail())) {
